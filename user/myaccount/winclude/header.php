	...
	<div class="main_menu">
		<nav class="navbar navbar-expand-lg navbar-light main_box">
			<div class="container">
				...
				<a class="navbar-brand logo_h" href="index.php" style="font-size: 30px; "><i class="fa fa-book mr-2" style="color: #ff6c00"></i>BookCart</a>
			...
			<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
				<ul class="nav navbar-nav menu_nav ml-auto">
					...
					if($_SESSION['login']){
						...
						<li class="nav-item"><a class="nav-link" href="logout.php">My Account</a></li>
