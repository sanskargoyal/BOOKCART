              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4"><i class="fa fa-book mr-2 shadow-sm" style="color: #ff6c00"></i>BOOKCART | Forgot Password</h1>
                    <span>Recover Your Account</span>
                  </div>
                  <form class="user mt-4" action="user_pages/forgot.php" method="POST">
                    ...
                    <button type="submit" class="btn text-light shadow-sm btn-user btn-block" style="background-color: #ff6c00">
                      Enter Your Email
                    </button>
                  </form>
                  <hr class="shadow-sm">
