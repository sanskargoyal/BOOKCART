              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4"><i class="fa fa-book mr-2 shadow-sm" style="color: #ff6c00"></i>BOOKCART | Login Area</h1>
                  </div>
                  
                  <form class="user" action="admin_pages/authentication.php" method="POST">
                    ...
                    <button type="submit" class="btn btn-user btn-block text-light shadow-sm" style="background-color: #ff6c00">
                      Login
                    </button>
                  </form>
                  <hr class="shadow-sm">
                  <div class="text-center">
                    <a class="small" href="forgot_pw.php">Forgot Password?</a>
                  </div>
                  <div class="text-center">
